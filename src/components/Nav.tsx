...
export function Nav({ children }: { children: ReactNode }) {
  return (
    <nav className="flex p-5 justify-between items-center border">
      <div className="flex items-center">
      <div className="shrink-0">
        <a href="/">
          <img
            className=" w-auto h-8 dark:block"
        ...
        <NavigationMenuList>
          <NavigationMenuItem className="flex justify-center items-center">
            ...
            <NavigationMenuContent className="w-full md:w-[400px] lg:w-[500px]">
              <ul
                className="max-w-full z-10 bg-white p-4 shadow-lg dark:bg-gray-800"
              >
